...
import decaf.tree.Tree.NumTest;
import decaf.tree.Tree.QuestionAndColon;
...
public abstract class Tree {
    ...
    public static final int QUESTION_COLON = STRING + 1;
    public static final int NUMINSTANCES = QUESTION_COLON  + 1;
    public static final int GUARDEDES = NUMINSTANCES + 1;
    public static final int GUARDEDIFSTMT = GUARDEDES + 1;
    ...
    public static abstract class Visitor {
        ...
        public void visitQuestionAndColon(QuestionAndColon that)
        {
        	visitTree(that);
        }
        ...
        public void visitNumTest(NumTest that) {
            visitTree(that);
        }
