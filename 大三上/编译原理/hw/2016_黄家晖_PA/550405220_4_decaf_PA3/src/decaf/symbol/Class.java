...
public class Class extends Symbol {
	...
	public Label getCopyFuncLabel() { return copyFuncLabel; }

	public void setCopyFuncLabel(Label copyFuncLabel) {
		this.copyFuncLabel = copyFuncLabel;
	}
