...
public abstract class Tree {
    ...
    /**
     * Repeat-statement, of type Repeat.
     */
     ...
     */
    public static final int LABELLED = REPEAT + 1;
    ...
    public static final int PCLONE = PRINT + 1;
    ...
    public static class Case extends Tree {
        ...
        public Case(Expr condition, List<Tree> block, Location loc) {
            super(CASE, loc);
            this.condition = condition;
            this.block = block;
        }
    ...
    public static class Switch extends Tree {
        ...
        public Expr condition;
        public List<Case> actions;
        public List<Tree> defaultStmt;

        public Switch(Expr condition, List<Case> actions,
                      List<Tree> defaultStmt, Location loc) {
            super(SWITCH, loc);
            this.condition = condition;
    ...
    public static class Repeat extends Tree {
        ...
        public Expr condition;
        public Block actions;

        public Repeat(Expr condition, Block actions, Location loc) {
            super(REPEAT, loc);
            this.condition = condition;
            this.actions = actions;
        }
        ...
        public void printTo(IndentPrintWriter pw) {
            ...
            pw.incIndent();
            condition.printTo(pw);
            if (actions != null && actions.block != null) {
                for (Tree s : actions.block) {
                    s.printTo(pw);
                }
            }
            pw.decIndent();
    ...
    /**
      * A ternary operation. (conditional expression)
      */
