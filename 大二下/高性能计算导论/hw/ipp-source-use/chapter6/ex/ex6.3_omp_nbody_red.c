 ...
 *           parallelizes inner for loops and uses a single critical 
 *           directive to protect all updates to the forces.
 *
 * Compile:  gcc -g -Wall -fopenmp -o ex6.3_omp_nbody_red 
 *                 ex6.3_omp_nbody_red.c -lm
...
#  pragma omp parallel num_threads(thread_count) \
      ...
      shared(n, n_steps, output_freq, delta_t, curr, forces)
   {
