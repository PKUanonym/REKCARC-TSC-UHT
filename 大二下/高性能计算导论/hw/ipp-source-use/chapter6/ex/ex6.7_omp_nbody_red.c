 ...
 *           a cyclic distribution.  This version uses
 *           schedule(runtime)
 *
 * Compile:  gcc -g -Wall -fopenmp -o ex6.7_omp_nbody_red 
 *                 ex6.7_omp_nbody_red.c -lm
 *           To turn off output (e.g., when timing), define NO_OUTPUT
 *           To get verbose output, define DEBUG
 *
 * Run:      ./ex6.7_omp_nbody_red <number of threads> <number of particles>
