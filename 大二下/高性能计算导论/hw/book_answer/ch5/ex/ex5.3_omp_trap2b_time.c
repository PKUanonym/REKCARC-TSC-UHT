/* File:    ex5.3_omp_trap2b_time.c
 * Purpose: Estimate definite integral (or area under curve) using trapezoidal 
 *          rule.  This version uses a reduction clause.  It's a modified
 *          version of omp_trap2b.c that includes timing results.
 *
 * Input:   a, b, n
 * Output:  estimate of integral from a to b of f(x)
 *          using n trapezoids.
 *
 * Compile: gcc -g -Wall -fopenmp -o ex5.3_omp_trap2b_time 
 *             ex5.3_omp_trap2b_time.c
 * Usage:   ./ex5.3_omp_trap2b_time <number of threads>
 *
 * Notes:   
 ...
 *       number of threads
 *
 * IPP:  Section 5.4 (pp. 223 and ff.) and Exercise 5.3
 */
