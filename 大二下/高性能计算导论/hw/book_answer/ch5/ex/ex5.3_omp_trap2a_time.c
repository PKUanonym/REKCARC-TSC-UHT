 ...
 *          call.  It's a modified version of omp_trap2a that includes
 *          timing results.
 *
 * Input:   a, b, n
 ...
 *          using n trapezoids.
 *
 * Compile: gcc -g -Wall -fopenmp -o ex5.3_omp_trap2a_time 
 *             ex5.3_omp_trap2a_time.c -lm
 * Usage:   ./ex5.3_omp_trap2a_time <number of threads>
 *
 * Notes:   
 *   1.  The function f(x) is hardwired.
 *   2.  This version assumes that n is evenly divisible by the 
 *       number of threads
 * IPP:  Section 5.4 (p. 222) and Exercise 5.3
 */
