 ...
 *           It is modified version pth_pi_mutex.c:  the mutex is acquired
 *           in the for loop instead of after the for loop.
 *
 * Compile:  gcc -g -Wall -o ex4.5_pth_pi_mutex ex4.5_pth_pi_mutex.c 
 *                 -lm -lpthread
