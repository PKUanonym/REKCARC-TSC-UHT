 ...
 *
 * Compile:  gcc -g -Wall -o ex4.18_pth_mat_vect_pad 
 *                 ex4.18_pth_mat_vect_pad.c -lpthread
 * Usage:
 *     ex4.18_pth_mat_vect_pad <thread_count>
 *
 * Notes:  
